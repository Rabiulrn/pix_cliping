...
@section('content')
                ...
                <div class="col-12 col-md-6">
                    <div class="row intro">
                        <div class="col-12 p-0">
                            ...
                            <a href="#" target="_blank" class="btn primary-button d-inline-block m-3 rounded-3">FREE TRAIL <i class="icon-arrow-right"></i></a>
                            <a href="#" target="_blank" class="btn btn-outline-primary border-1 d-inline-block m-3 rounded-3">GET STARTED <i class="icon-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Benefits -->
    <section class=" featured" style="background-color: white; padding:100px 0;">
        <div class="overflow-holder">
            <div class="container">
                <div class="row text-center intro">
                    <div class="col-12">
                        <h2 class="mb-0">Jewelry Photo Retouching <br> for Credible Visuals</h2>
                        <p class="mt-4">Your customer wants to see photos they can rely on for a successful purchase. <br> Color Clipping retouch to reach that goal.</p>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-12 col-md-6">
