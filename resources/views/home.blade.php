        ...
        <div class="swiper-container no-slider animation slider-h-100">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide-center">
                    <img data-aos="zoom-out-up" data-aos-delay="800" src="/front-assets/images/home/Home2.png" class="hero-image" alt="Hero Image">
                        ...
                        <div class="col-12 d-flex inner">
                            <div class="left">
                                ...
                                <div class="flex gap-2">
                                    <a href="{{route('free-trail')}}" class="btn primary-button d-inline-block me-2">FREE TRAIL <i class="icon-arrow-right"></i></a>
                                    <a href="{{route('register')}}" target="_blank" class="btn btn-outline-warning border-1 d-inline-block">GET STARTED <i class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="tab-content mt-5">
                        <div class="tab-pane container active" id="editing">
                            <div class="row">
                                <div class="col-4">
                                    <div class="p-2" style="background-color: ghostwhite; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            <div class="col-3">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','clipping-path')}}"><h5 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Clipping Path</h5></a>
                                                    <p style="text-align: left; margin: 10px 0px 10px 0px; font-size:14px;">Cut out the subject with shape by hand-drawn photo clipping service.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="p-2" style="    background: radial-gradient(circle, rgb(219 207 211) 3%, rgb(235 237 239) 100%); border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            <div class="col-3">
                                                <i class="icon icon-globe" style="position: relative; top:40px; left: 10px"></i>
                                            </div>
                                    ...
                                    <div class="p-2" style="background: rgb(194,191,192);
background: radial-gradient(circle, rgba(194,191,192,1) 3%, rgba(238,239,240,1) 100%); border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            <div class="col-3">
                                                <i class="icon icon-globe" style="position: relative; top:40px; left: 10px"></i>
                                            </div>
                                ...
                                <div class="col-4">
                                    <img src="/front-assets/images/home/hometab.png" class="fit-image" alt="editing" >
                                </div>
                                <div class="col-4">
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                        ...
                        <div class="tab-pane container fade" id="retouching">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','product-photo-retouching')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Product Photo Retouching</h4></a>
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','beauty-retouching')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Beauty Retouching</h4></a>
                                ...
                                <div class="col-4">
                                    <img src="/front-assets/images/home/services/Editing.png" class="fit-image" alt="editing" >
                                </div>
                                <div class="col-4">
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','real-estate-photo-editing')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Real Estate Photo Editing</h4></a>
                                ...
                                <div class="col-4">
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','essential-editing')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Essential Editing</h4></a>
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','amazon-e-bay-shopify')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Amazon, e-Bay, Shopify Ready</h4></a>
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','ecommerce-360-degree-editing')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">E-commerce 360 degree editing</h4></a>
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','image-optimization')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Image Optimization</h4></a>
                                ...
                                <div class="col-4">
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','product-photography')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Product Photography</h4></a>
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','apparels-photography')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Apparels Photography</h4></a>
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','jewelry-photography')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">Jewelry Photography</h4></a>
                                    ...
                                    <div class="p-2" style="background-color: #fff; border-radius: 5px; margin-bottom: 10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <div class="featured">
                                                    <a href="{{route('services.slug','school-photography')}}"><h4 class="text-red-500" style="color: #fc5130; margin: 10px 0px 10px 0px; text-align: left;">School Photography</h4></a>
